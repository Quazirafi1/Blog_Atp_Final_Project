...
@section('content')
    <div class="header-bg">
        <img src="{{ url('storage/post/'. $post->image) }}" alt="{{$post->title}}" height="400px" width="100%">
    </div><!-- slider -->
                    ...
                    <div class="main-post">
                        ...
                        <div class="post-icons-area">
                            <ul class="post-icons">
                                <li>
                                    @guest
                                        <a href="javascript:void(0);" onclick="toastr.info('Must Be Authenticated User To Access This Feature','Information',{
                                                    closeButton: true,
                                                    progressBar: true,
