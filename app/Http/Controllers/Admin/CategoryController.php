...
//            resize image for category and upload
        ...
        $category->save();
        \Brian2694\Toastr\Facades\Toastr::success('Category Created Successfully', 'Success');
...
//            resize image for category and upload
        ...
        $category->image = $imagename;
        $category->save();
        \Brian2694\Toastr\Facades\Toastr::success('Category Updated Successfully', 'Success');
        return redirect()->route('admin.category.index');
    }
    ...
    public function destroy($id)
    {
        ...
        $category->delete();
        \Brian2694\Toastr\Facades\Toastr::success('Category Deleted Successfully', 'Success');
